...
# 获取批次batch
train_dir = '/home/jjd/PycharmProjects/data/flower_input_data'  # 训练样本的读入路径
logs_train_dir = '/home/jjd/PycharmProjects/flower_world-master/save'  # logs存储路径
...
# training=True
# train_logits = model.MobilenetV2(train_batch, training)
